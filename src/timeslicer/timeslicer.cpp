...
bool timeslicer::eval_tick_valid_timeslice(Slice_pattern slice_pattern, uint8_t sub_idx)
{
    switch (slice_pattern)
    {
        ...
        case Slice_pattern::TWOS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0000'0001)) == sub_idx);

        case Slice_pattern::FOURS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0000'0011)) == sub_idx);

        case Slice_pattern::EIGHTS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0000'0111)) == sub_idx);

        case Slice_pattern::SIXTEENS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0000'1111)) == sub_idx);

        case Slice_pattern::THIRTYTWOS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0001'1111)) == sub_idx);

        case Slice_pattern::SIXTYFOURS:
            return ((g_tick_counter & static_cast<uint8_t>(0b0011'1111)) == sub_idx);
